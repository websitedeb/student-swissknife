...
const Menubar = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-10 items-center space-x-1 rounded-md border border-red-800 bg-color-3 text-white p-1 dark:border-neutral-800 dark:bg-neutral-950",
      className
    )}
    {...props} />
))
...
const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm font-medium outline-none focus:bg-red-600 focus:text-white data-[state=open]:bg-red-600 data-[state=open]:bg-red-600 dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[state=open]:bg-neutral-800 dark:data-[state=open]:text-neutral-50 hover:bg-red-950"
    )}
    {...props} />
))
...
const MenubarContent = React.forwardRef((
  { className="bg-color-4 text-white border-red-900", align = "start", alignOffset = -4, sideOffset = 8, ...props },
  ref
) => (
...
const MenubarItem = React.forwardRef(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none bg-color-2 focus:bg-neutral-100 focus:text-neutral-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50",
      inset && "pl-8",
      className
    )}
    {...props} />
...
const MenubarSeparator = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-color-5 dark:bg-neutral-800", className)}
    {...props} />
))
